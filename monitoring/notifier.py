                ...
                "attachments": [
                    {
                        ...
                        "blocks": [
                            {
                                "type": "section",
                                "text": {"type": "mrkdwn", "text": ":rocket: *Music Streaming Pipeline — Started*"},
                            },
                            {
                                "type": "section",
                                "fields": [
                            ...
                            },
                            {
                                ...
                                "elements": [
                                    {
                                        "type": "mrkdwn",
                                        "text": "Crawler → Validate → Transform → KPIs → DynamoDB → Archive",
                                    }
                                ],
                            },
                        ],
                ...
                "attachments": [
                    {
                        ...
                        "blocks": [
                            {
                                "type": "section",
                                "text": {"type": "mrkdwn", "text": ":red_circle: *Music Streaming Pipeline — FAILED*"},
                            },
                            {
                                "type": "section",
                                "fields": [
            ...
            "attachments": [
                {
                    "color": color,
                    "blocks": [
                        {"type": "section", "text": {"type": "mrkdwn", "text": f"{emoji} *{jobName}* — *{status}*"}},
                        {
                            "type": "section",
                            "fields": [
            ...
            "attachments": [
                {
                    "color": "#E01E5A",
                    "blocks": [
                        {"type": "section", "text": {"type": "mrkdwn", "text": f":red_circle: *{jobName}* — *Failed*"}},
                        {
                            "type": "section",
                            "fields": [
                                {"type": "mrkdwn", "text": f"*Stage:*\n`{stage}`"},
